...
An example startup script for starting a wine application.. In this case, it's the script that I use for starting Reaper; making use of all of the features from wine, wine-staging and wine-lpa via environment variables.
